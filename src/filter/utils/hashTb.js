...
export const hashTbStockFilter = {
  ...
  "Bộ lọc theo tín hiệu kỹ thuật BETA": [
    ...
    { name: "Tín hiệu đường xu hướng: chuyển trạng thái", key: "", selectCondition: false },
    { name: "Tín hiệu chỉ báo kỹ thuật: chuyển trạng thái", key: "", selectCondition: false },
    { name: "Tín hiệu kỹ thuật tổng hợp: chuyển trạng thái", key: "", selectCondition: false },
  ],
};
