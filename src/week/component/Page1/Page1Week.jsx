...
const Page1Week = () => {
  ...
  return (
    <div className="h-[1152px] w-[800px] relative  ">
      ...
      <div className="absolute top-0 left-0 translate-x-[127px] translate-y-[488px]">
        <p
          className="text-[#fff] font-bold text-[60px] leading-[110px] tracking-wide my-1 font-[Poppins] text-outline"
        >
          {dateParts[0]} - {dateParts[1]}
        </p>
      </div>
      <div className="absolute top-0 left-0 translate-x-[130px] translate-y-[490px]">
        <p
          className="text-[#f4ae3f] font-bold text-[60px] leading-[110px] tracking-wide my-1 font-[Poppins]"
