            ...
            <div className='h-[945px] w-full'>
                ...
                <div className="content flex flex-col items-center ">
                    <div className=" h-[600px] w-[760px]">
                        ...
                        <div className="body ">
                            <p className="m-0 text-[#0155B7] font-bold text-[18px]">TUYÊN BỐ MIỄN TRÁCH NHIỆM</p>
                            <div>
                                <p className="m-0 text-[15px]  leading-5 text-justify indent-[30px] ">
                                    Báo cáo này được viết và phát hành bởi BETA. Thông tin, tuyên
                                    bố, dự đoán trong báo cáo này bao gồm cả các nhận định cá nhân
                                    là dựa trên các nguồn thông tin tin cậy. Tuy nhiên, BETA không
                                    đảm bảo về sự hoàn chỉnh cũng như độ chính xác của các nguồn
                                    thông tin này. Các ý kiến dự báo chỉ thể hiện quan điểm của
                                    người viết tại thời điểm phát hành và có thể thay đổi mà không
                                    cần thông báo với người đọc. BETA không có nghĩa vụ phải cập
                                    nhật, sửa đổi báo cáo này dưới mọi hình thức cũng như thông báo
                                    với người đọc trong trường hợp các quan điểm dự báo trong báo
                                    cáo này thay đổi hoặc trở nên không chính xác.
                                </p>
                                <p className="m-0 text-[15px]  leading-5 text-justify indent-[30px] ">
                                ...
                                <p className="m-0 text-[15px]  leading-5 text-justify indent-[30px] ">
                                    ...
                                    BETA sẽ không chịu trách nhiệm đối với tất cả hay bất kỳ thiệt
                                    hại nào hay sự kiện bị coi là thiệt hại đối với việc sử dụng
                                    toàn bộ hay bất kỳ thông tin hoặc ý kiến nào của báo cáo này.
                                    Không ai được sao chép, tái bản hoặc phát hành cũng như tái phân
                                    phối báo cáo vì bất kỳ mục đích nào nếu không được sự đồng ý
                                    bằng văn bản của BETA. Xin vui lòng ghi rõ nguồn khi trích dẫn
