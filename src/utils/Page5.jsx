            ...
            <p>
              ...
              <span
                className={`font-semibold ${
                  dataContribute.change > 0 ? "text-green-500" : "text-red-500"
                }`}
              >
                {formatNumber(dataContribute.change)}
              </span>{" "}
              điểm (
              <span
                className={`font-semibold ${
                  dataContribute.perChange > 0
                    ? "text-green-500"
                    : "text-red-500"
                }`}
              >
                {formatNumber(dataContribute.perChange)}%
              </span>
              ) trong đó ghi nhận tổng giá trị giao dịch đạt{" "}
              ...
              {dataContribute.advance > dataContribute.decline ? (
                <span>
                  ...
                  với {dataContribute.decline} mã cổ phiếu{" "}
                  <span className="font-semibold text-red-500">giảm</span>
                </span>
              ) : (
                <span>
                  {" "}
                  ...
                  với {dataContribute.advance} mã cổ phiếu{" "}
                  <span className="font-semibold text-green-500">tăng.</span>
                </span>
              )}
            </p>
          </div>
