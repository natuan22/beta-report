...
const Page3 = () => {
    ...
    return (
        <div className="h-[1480px] w-[800px] ">
            ...
            <div className="content-top flex flex-col items-center justify-evenly h-[510px] mt-5  ">
            ...
            <div className="content-bot mt-5 flex flex-col items-center  h-[400px]">
                <div className="title text-center">
                    <h2
                        className="m-0 text-[30px] text-[#064BAD] "
                        style={{ textShadow: "-2px 3px 3px #E88C08 " }}
                ...
                <div className={`stockRecommend   w-[800px] ${data?.stock.length > 2 ? 'flex flex-wrap items-center justify-center' : 'flex flex-col justify-center items-center'}`}>
                    {data?.stock.map((item) => {
                        return (
                            <div className="stock-card flex  items-center   w-[47%] my-[35px] border-1 border-collapse border-solid border-[#116DDF] mr-2 rounded-lg ">
                                ...
                                <div className="stock-card_content w-[250px]  translate-x-[-40px] ">
