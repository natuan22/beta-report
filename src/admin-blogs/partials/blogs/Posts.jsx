                      ...
                      <tr key={index}>
                        ...
                        <td className="p-1 whitespace-nowrap">
                          <div className="text-center">
                            ...
                            ) : post.published === 0 && (post.scheduledAt === null || moment(post.scheduledAt).isBefore(moment())) ? (
                              <IoMdCloseCircleOutline className="w-6 h-6 text-red-400" />
                            ) : (
                              <Tooltip placement="bottom" title={<div>{moment(post.scheduledAt).format("DD/MM/YYYY HH:mm")}</div>}>
