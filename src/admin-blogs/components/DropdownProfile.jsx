...
const DropdownProfile = ({ align, role, user, handleUserLogout }) => {
        ...
        >
          <div className="pt-0.5 pb-2 px-3 mb-1 border-b border-gray-200 dark:border-gray-700/60">
            ...
            <div className="text-xs text-gray-500 dark:text-gray-400 italic">
              {role === process.env.REACT_APP_ADMIN_BLOGS ? "Administrator Blogs" : ""}
            </div>
          </div>
          <ul className="list-none ps-0">
            <li>
              <Link
                className="font-medium text-sm text-violet-500 hover:text-violet-600 dark:hover:text-violet-400 flex items-center py-1 px-3 no-underline"
                to="/"
