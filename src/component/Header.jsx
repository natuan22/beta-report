        ...
        <div className="p-2 flex items-center">
            ...
            <div className="header-left_top flex items-center justify-start mb-4">
              ...
              <div className="text ml-4 translate-y-[-2px]">
                <div className="w-[324px]">
                  <p className="text-[17px] font-bold  text-[#2163C6] m-0 tracking-wider">
                    Công ty Cổ Phần Chứng Khoán BETA
                  </p>
                </div>
                <p className="text-[12px] font-bold text-[#FCA017] m-0 tracking-wide">
                  Ấn bản được phát hành bởi BETA{" "}
                </p>
              </div>
            </div>
          ...
          <div className="header-right">
            <img
              ...
              width={211}
              height={141}
              className="translate-y-[16px] translate-x-[105px]"
            />
          </div>
        </div>
      ) : (
        <div className=" flex items-center  relative">
          <div className="header-left flex items-center justify-start translate-y-[18px] translate-x-[10px]">
            ...
            <div className="text ml-2 translate-y-[-2px]">
              <div className="w-[324px]">
                <p className="text-[17px] font-bold  text-[#2163C6] m-0 tracking-wide ">
                  Công ty Cổ Phần Chứng Khoán BETA
                </p>
              </div>
              <p className="text-[12px] font-bold text-[#FCA017] m-0 tracking-wide">
          ...
          <div className="header-right">
            <img
              ...
              width={145}
              height={80}
              className="translate-x-[230px] translate-y-[2px]"
            />
          </div>
